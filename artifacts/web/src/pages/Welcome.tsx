...
import {
  ...
  ArrowRight, ChevronDown, Star, Zap, Crown, Check, Mail, Music,
} from "lucide-react";
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Stay in your trading zone without switching apps. Connect Spotify and control your focus playlist from a floating mini-player that follows you everywhere in the app.",
    bullets: [
      "Floating mini-player visible on every page",
      "Play, pause, skip, and scrub without leaving your workflow",
      "Connect any Spotify playlist — lo-fi, focus, or your own",
      "Requires Spotify Premium — one connection, always remembered",
    ],
  },
];
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 pt-14">
        ...
        {/* ── Spotify Callout ── */}
        <section className="px-6 py-8 bg-green-950/30 border-y border-green-500/20">
          <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-bold text-green-400 uppercase tracking-widest mb-0.5">Spotify Integration</p>
                <p className="text-foreground font-semibold">Trade to your own beat — without ever leaving the app.</p>
                <p className="text-sm text-muted-foreground">Connect Spotify Premium and control your focus music from a floating player that follows you across every page.</p>
              </div>
            </div>
            <Link
              to="/signup"
              className="shrink-0 text-sm bg-green-500 text-white font-semibold px-5 py-2.5 rounded-lg hover:bg-green-400 transition-colors whitespace-nowrap"
            >
              Try It Free
            </Link>
          </div>
        ...
        <section className="px-6 py-14 sm:py-20">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="w-full rounded-2xl overflow-hidden shadow-2xl border border-border bg-card aspect-video">
              <video
                ...
                src={`${import.meta.env.BASE_URL}landing-page-walkthrough.mp4`}
              >
