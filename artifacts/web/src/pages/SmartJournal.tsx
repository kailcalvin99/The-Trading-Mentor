...
function isOutcomeType(value: unknown): value is OutcomeType {
  return value === "win" || value === "loss" || value === "breakeven" || value === "";
}

function isBehaviorTag(value: unknown): value is BehaviorTag {
  return value === "FOMO" || value === "Chased" || value === "Disciplined" || value === "Greedy";
}
...
export default function SmartJournal() {
  ...
  function openDraftForm(draft: ExtendedTrade) {
    ...
    setForm({
      ...
      outcome: isOutcomeType(draft.outcome) ? draft.outcome : "",
      notes: cleanNotes,
      behaviorTag: isBehaviorTag(draft.behaviorTag) ? draft.behaviorTag : "",
